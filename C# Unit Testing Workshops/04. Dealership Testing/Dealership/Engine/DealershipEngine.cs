...
namespace Dealership.Engine
{
    public class DealershipEngine : IEngine
    {
        ...
        protected IDealershipFactory factory;
        protected ICollection<IUser> users;
        protected IUser loggedUser;
        ...
        public DealershipEngine()
            : this(new DealershipFactory(), new ConsoleCommandParser())
        {
        }
        ...
        public void Reset()
        {
            ...
            this.PrintReports(commandResult);
            this.commandParser = new ConsoleCommandParser();
        }
