...
namespace Dealership.Engine
{
    public class Command : ICommand
    {
        ...
        protected virtual void TranslateInput(string input)
        {
            ...
            {
                this.Parameters.Add(input.Substring(indexOfOpenComment + CommentOpenSymbol.Length, indexOfCloseComment - (indexOfOpenComment + CommentOpenSymbol.Length)));
