    ...
    public class PackageRepository : IRepository<IPackage>
    {
        ...
        public IPackage Delete(IPackage package)
        {
            ...
            if (allDependencies.Count() > 0)
            {
                ...
                // here should the execturtion ot the method be stopped
                throw new ArgumentException("cannot delete a dependency package");
            }
        ...
        {
            // second bug found -> AddPackage which was left for tests is still called but should not be
